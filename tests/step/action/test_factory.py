...
def test_all_enum_values_present():
    ...
    missing_values = [
        action_name for action_name in ActionName if action_name not in factory_components
    ]
    assert not missing_values, f"Names missing from factory: {', '.join(missing_values)}"

    extra_values = [
        action_name for action_name in factory_components if action_name not in ActionName
    ]
