...
def add_args(parser: ArgumentParser) -> None:
    ...
    parser.add_argument(
        "--path",
        metavar="path",
        default=f"{get_repo_config_relative_path()}/scheduler.json",
        type=str,
...
def schedule_command_main(args: Namespace) -> None:
    ...
    # Get Scheduler
    event_args = {"scheduler_file": args.path}
    scheduler = Scheduler.read(args.path)
    ...
    scheduler.run(args.time, runner or LocalRunner())
